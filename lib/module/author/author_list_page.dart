...
import 'package:flutter_eyepetizer/module/author/author_list_view_model.dart';
...
class _AuthorListPageState extends State<AuthorListPage>
  ...
  late final AuthorListViewModel _viewModel;

  @override
  void initState() {
    super.initState();
    _viewModel = AuthorListViewModel(widget.apiUrl);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      value: _viewModel,
      child: Consumer<AuthorListViewModel>(
